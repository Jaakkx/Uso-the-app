 ...
 */
final class Version20211124095526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE send_email (id INT AUTO_INCREMENT NOT NULL, notion_page_id INT NOT NULL, user_id INT NOT NULL, destination_email VARCHAR(255) NOT NULL, INDEX IDX_8EF079321ACAE608 (notion_page_id), INDEX IDX_8EF07932A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE send_email ADD CONSTRAINT FK_8EF07932A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE send_email DROP FOREIGN KEY FK_8EF07932A76ED395');
